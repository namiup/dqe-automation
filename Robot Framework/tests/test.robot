...
Compare HTML and Parquet Data
    ...
    ${comparison_result}=    Evaluate    libraries.helper.compare_html_and_parquet(html_data, parquet_data)    modules=libraries.helper    html_data=${html_data}    parquet_data=${parquet_data}
